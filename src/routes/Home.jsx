      ...
      <section className="max-w-7xl min-h-screen flex flex-col justify-center items-center px-16">
        ...
        <div className="flex gap-10 font-[Swansea] mb-10">
          <div className="flex-1">
            ...
            <p>
              My goal is to{" "}
              <em>bring to life modern and particular projects</em>, for this I
              study and make use of the latest technologies that allow me to
          ...
          <div className="flex-1">
            <p>
              ...
              can get bigger. The passion for innovative design is fueled by the
              goals and needs of your company. There are no projects too big or
              too small.
            </p>
            <p>
